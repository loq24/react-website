      ...
      <div>
        ...
        <div className="project-row left">
          ...
          <p>
            ...
            podcasts. This is one of the biggest app that I made. I learned a
            lot about handling huge data in REST API and enhanced more my
            Typescript knowledge as well.
          </p>
          <p className="tools">
            <span>React Native</span>
            <span>React Redux</span>
      ...
      <div>
        ...
        <div className="project-row left">
          ...
          <p>
            ...
            developers who worked on it's redesign.
          </p>
          <p className="tools">
            <span>PHP</span>
